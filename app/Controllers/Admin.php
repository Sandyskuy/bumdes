...
class Admin extends BaseController
{
    ...
    {
        // Ambil semua data pengguna dengan peran 'staff', 'superadmin', dan 'admin'
        $users = $this->userModel->select('*')->whereIn('role', ['super_admin', 'admin'])->findAll();
    ...
    {
        // Ambil semua data pengguna dengan peran 'staff', 'superadmin', dan 'admin'
        $users = $this->userModel->select('*')->whereIn('role', ['staff'])->findAll();
    ...
    {
        // Ambil semua data pengguna dengan peran 'superadmin', dan 'admin'
        $users = $this->userModel->select('*')->whereIn('role', ['admin', 'super_admin'])->findAll();
